...
# Conditional score model for the representation of the numbers 0 to 9
class ConditionalScoreNet(ScoreNet):
  """Class-conditional time-dependent score-based model."""
  ...
  def forward(self, x, t, y):
    ...
    embed = self.act(self.embed(t)) + self.label_emb(y)
